...
export default function BookingForm() {
  ...
  const currentEditingId = useSelector(
    (state) => state.booking.currentEditingId
  );
  const status = useSelector((state) => state.booking.status);

  const handleChange = (e) => {
    dispatch(
      updateBookingField({ field: e.target.name, value: e.target.value })
    );
  };
  ...
  return (
    <div className='flex min-h-screen items-center justify-center'>
      <div className='relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none'>
        <h4 className='block font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-600 antialiased'>
          {currentEditingId ? 'Edit Booking' : 'Book Now'}
        </h4>
        ...
        >
          <div className='mb-4 flex flex-col gap-6'>
            ...
            <div className='relative w-full min-w-[200px]'>
              <textarea
                className='peer h-full min-h-[100px] w-full resize-none rounded-md border border-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-blue-500 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50'
                name='description'
